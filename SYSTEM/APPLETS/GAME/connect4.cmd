...
title "Connect Four(Liscensed for Nyra OS)"
:titlescreen
color 0A
cls
Echo.
...
Echo *************************************************
Echo.
echo Welcome to Connect 4, %USERNAME% 
Echo.
Echo *************************************************
Echo.
Echo Original By Mastahhaxor
echo Edited by Jessica Fawkes
Echo.
Echo.
Echo 1)Play Game
Echo 2)Instructions
...
echo IMPORTANT NOTE: This version has been edited by Jessica Fawkes.
Echo.
Echo.
pause
goto superstart
...
Echo Congratulations, %xs%, you win!
pause
goto ending
:wino
cls
...
Echo.
Echo.
Echo Congratulations %os%, you win!
pause 
goto ending
:draw
cls
...
Echo Press 2 to Change Player Names
